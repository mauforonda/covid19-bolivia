...
Ocasiones en que he editado manualmente los datos debido a interrupciones del servicio de datos:
- 25 de Abril: datos de confirmados y decesos
- 29 de Julio: datos de confirmados, recuperados y decesos
